...
dependencyOverrides in ThisBuild ++= Seq(
  ...
  "io.github.scalan" % "common_2.12" % "i8-more-ops-d7c2b8b4-SNAPSHOT",
  "io.github.scalan" % "core_2.12" % "i8-more-ops-d7c2b8b4-SNAPSHOT",
  "io.github.scalan" % "library-api_2.12" % "i8-more-ops-d7c2b8b4-SNAPSHOT",
  "io.github.scalan" % "library-impl_2.12" % "i8-more-ops-d7c2b8b4-SNAPSHOT",
  "io.github.scalan" % "library_2.12" % "i8-more-ops-d7c2b8b4-SNAPSHOT",
  "io.github.scalan" % "macros_2.12" % "i8-more-ops-d7c2b8b4-SNAPSHOT",
  "io.github.scalan" % "meta_2.12" % "i8-more-ops-d7c2b8b4-SNAPSHOT",
  "io.github.scalan" % "sigma-api_2.12" % "new-ops-105b47d0-SNAPSHOT",
  "io.github.scalan" % "sigma-impl_2.12" % "new-ops-105b47d0-SNAPSHOT",
  "io.github.scalan" % "sigma-library_2.12" % "new-ops-105b47d0-SNAPSHOT",
...
// LIBRARY_DEPENDENCIES_HASH 67728aa0791dd3d8bc0790503f83456bcc983661
