...
dependencyOverrides in ThisBuild ++= Seq(
  ...
  "io.github.scalan" % "common_2.12" % "master-432323a8-SNAPSHOT",
  "io.github.scalan" % "core_2.12" % "master-432323a8-SNAPSHOT",
  "io.github.scalan" % "library-api_2.12" % "master-432323a8-SNAPSHOT",
  "io.github.scalan" % "library-impl_2.12" % "master-432323a8-SNAPSHOT",
  "io.github.scalan" % "library_2.12" % "master-432323a8-SNAPSHOT",
  "io.github.scalan" % "macros_2.12" % "master-432323a8-SNAPSHOT",
  "io.github.scalan" % "meta_2.12" % "master-432323a8-SNAPSHOT",
  "io.github.scalan" % "sigma-api_2.12" % "master-0fefe30d-SNAPSHOT",
  "io.github.scalan" % "sigma-impl_2.12" % "master-0fefe30d-SNAPSHOT",
  "io.github.scalan" % "sigma-library_2.12" % "master-0fefe30d-SNAPSHOT",
...
// LIBRARY_DEPENDENCIES_HASH f38d55f7e44fe63ea327eb3463f82a9149462743
