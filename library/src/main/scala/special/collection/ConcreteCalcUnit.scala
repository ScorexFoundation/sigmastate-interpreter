package special.collection {
  ...
  trait ConcreteCalcs extends Base { self: Library =>
    ...
    abstract class CCalcPrim[Val](val value: Ref[Val], val size: Ref[Size[Val]]) extends CalcPrim[Val] {
    ...
    trait CCalcPrimCompanion;
    trait CCalcPairCompanion;
    trait CCalcFuncCompanion;
    trait CCalcCollCompanion;
    trait CCalcBuilderCompanion
  }
}