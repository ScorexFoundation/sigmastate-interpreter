...
%\algname can be considered a combination of \zerocoin and CoinJoin. 
...
%The difference lies in the way the output boxes are created. 
...
%The protocol overcomes two of the main weaknesses of CoinJoin~\cite{coinjoin}, namely the requirement of interaction and the susceptibility to eavesdropping attacks. 
