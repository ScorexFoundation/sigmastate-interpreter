...
Figure~\ref{fig:mixingtokens} gives an example flow of the protocol with the above contracts in place. Note that for simplicity we do not show fee in the transactions and implicitly assume that the an additional output is the fee. 
