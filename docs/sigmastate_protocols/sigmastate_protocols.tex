...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		The box $O_b$ contains data $(h, v)$ and $O_{1-b}$ contains $(v, h)$. 
...
val c0 = SELF.R5[GroupElement].get
val c1 = SELF.R6[GroupElement].get
proveDlog(c1) || proveDHTuple(g, c0, u, c1)
\end{verbatim}

Next create a script, \texttt{halfMixScript}, having the following code:
\begin{verbatim}
val u = SELF.R4[GroupElement].get
val u_0 = OUTPUT(0).R4[GroupElement].get
val c0_0 = OUTPUT(0).R5[GroupElement].get
val c1_0 = OUTPUT(0).R6[GroupElement].get
val u_1 = OUTPUT(1).R4[GroupElement].get
val c0_1 = OUTPUT(1).R5[GroupElement].get
val c1_1 = OUTPUT(1).R6[GroupElement].get
val bob = u_0 == u && u_1 == u && c0_0 == c1_1 && c1_0 == c0_1 && 
          (proveDHTuple(g, u, c0_0, c1_0) || proveDHTuple(g, u, c1_0, c0_0))
