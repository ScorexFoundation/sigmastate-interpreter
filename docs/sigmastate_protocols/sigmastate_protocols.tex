...
\subsection{\mixname: Scalable ZeroCoin and Non-Interactive CoinJoin}
\label{mix}
...
In \mixname, this interaction is replaced by public participation using the blockchain. While this adds one more transaction, it does not require interaction between the parties. Note that \mixname transactions (both half and full mix) are detectable, while CoinJoin transactions look like ordinary transactions. 
