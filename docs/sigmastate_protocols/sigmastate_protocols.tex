...
Any funds sent to this address can only be spent in a transaction that creats boxes paying to Alice, Bob and Carol in the ratios defined above (after deducting transaction fee).
