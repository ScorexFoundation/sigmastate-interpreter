...
\knote{Why are you talking about ErgoScript? Lets have a description of consensus-critical things
in the main text, i.e. ErgoTree only. ErgoScript could be described in an appendix.}
...
\knote{the following text is broken} All $n$-ary lambdwhen $n>1$
