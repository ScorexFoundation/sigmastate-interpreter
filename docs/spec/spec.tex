...
\usepackage{mathtools,color,xcolor,hyperref,graphicx,wrapfig,listings,caption}
\usepackage{array,xspace,tabu,stmaryrd,tabularx,verbatim,longtable,multirow,float}

\captionsetup[table]{singlelinecheck=0,position=above}
...
\title{\ASDag Specification for Ergoplatform 3.0}
