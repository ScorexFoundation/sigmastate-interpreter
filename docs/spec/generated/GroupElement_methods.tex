...
\begin{tabularx}{\textwidth}{| l | X |}
  ...
  \bf{Serialized as} & \hyperref[sec:serialization:operation:Exponentiate]{\lst{Exponentiate(opCode=159)}} \\
  \hline
...
\begin{tabularx}{\textwidth}{| l | X |}
  ...
  \bf{Serialized as} & \hyperref[sec:serialization:operation:MultiplyGroup]{\lst{MultiplyGroup(opCode=160)}} \\
  \hline
