...
\begin{tabularx}{\textwidth}{| l | X |}
  ...
  \bf{Serialized as} & \hyperref[sec:serialization:operation:PlusModQ]{\lst{PlusModQ(opCode=232)}} \\
  \hline
...
\begin{tabularx}{\textwidth}{| l | X |}
  ...
  \bf{Serialized as} & \hyperref[sec:serialization:operation:MinusModQ]{\lst{MinusModQ(opCode=233)}} \\
  \hline
