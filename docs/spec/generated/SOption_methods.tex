...
\begin{tabularx}{\textwidth}{| l | X |}
  ...
  \bf{Serialized as} & \hyperref[sec:serialization:operation:OptionIsDefined]{\lst{OptionIsDefined(opCode=230)}} \\
  \hline
...
\begin{tabularx}{\textwidth}{| l | X |}
  ...
  \bf{Serialized as} & \hyperref[sec:serialization:operation:OptionGet]{\lst{OptionGet(opCode=228)}} \\
  \hline
...
return the result of evaluating \lst{default}.
  ...
  \bf{Serialized as} & \hyperref[sec:serialization:operation:OptionGetOrElse]{\lst{OptionGetOrElse(opCode=229)}} \\
  \hline
