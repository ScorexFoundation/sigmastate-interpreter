...
$$(height \ge timeout \land dlog(x_B)) \lor (height < timeout \land dlog(x_P) 
\land Exists(Outputs, 20, ExtractAmount(TaggedBox(20)) \ge to\_raise \land ExtractScriptBytes(TaggedBox(20)) = ToBytes(dlog(x_P))))$$
