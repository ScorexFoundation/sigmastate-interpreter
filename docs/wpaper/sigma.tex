...
We assume that a {\em prover} and a {verifier} have a shared context. We assume that this context is about current state of the blockchain, such as height of a best block $h$) and a spending transaction with outputs it spends and newly created outputs. 
