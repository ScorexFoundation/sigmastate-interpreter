...
\lnote{it is unclear to me how to create environments outside of Scala code, so I am not exactly sure what to write here, because typed objects live inside Scala.}
...
These registers provide additional capabilities to \langname. \lnote{atomic exchange example goes here}
