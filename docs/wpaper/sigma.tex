...
The next steps we plan to do~(and have partially done) after releasing this document are:
    \begin{enumerate}
        ...
        already have code for such examples done, and writing documentation about them at the moment.
        \item{} Detailed description of used type system, cost estimation procedure, safety guarantees and abstract syntax tree format.
    \end{enumerate}
