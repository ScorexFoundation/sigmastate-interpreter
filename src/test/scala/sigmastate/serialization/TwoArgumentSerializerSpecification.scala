...
class TwoArgumentSerializerSpecification extends TableSerializationSpecification {
  ...
  override val objects =
    Table(
      ("object", "bytes"),
      (Minus(LongConstant(2), LongConstant(3)), Array[Byte](MinusCode, SLong.typeCode, 0, 0, 0, 0, 0, 0, 0, 2, SLong.typeCode, 0, 0, 0, 0, 0, 0, 0, 3)),
      (Plus(LongConstant(2), LongConstant(3)), Array[Byte](PlusCode, SLong.typeCode, 0, 0, 0, 0, 0, 0, 0, 2, SLong.typeCode, 0, 0, 0, 0, 0, 0, 0, 3)),
      (Multiply(LongConstant(2), LongConstant(3)), Array[Byte](MultiplyCode, SLong.typeCode, 0, 0, 0, 0, 0, 0, 0, 2, SLong.typeCode, 0, 0, 0, 0, 0, 0, 0, 3)),
