...
//        }
    ...
    case ArithOp(l, r, OpCodes.MinusCode) => bimap(env, "-", l, r)(Minus)(SInt, SInt)
    case ArithOp(l, r, OpCodes.PlusCode) => bimap(env, "+", l, r)(Plus)(SInt, SInt)
    case ArithOp(l, r, OpCodes.MultiplyCode) => bimap(env, "*", l, r)(Multiply)(SInt, SInt)
    case ArithOp(l, r, OpCodes.ModuloCode) => bimap(env, "%", l, r)(Modulo)(SInt, SInt)
    case ArithOp(l, r, OpCodes.DivisionCode) => bimap(env, "/", l, r)(Divide)(SInt, SInt)
