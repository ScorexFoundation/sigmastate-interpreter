...
object ValueSerializer extends SigmaSerializerCompanion[Value[SType]] {
  ...
  private val serializers = SparseArrayContainer.buildFrom(Seq[ValueSerializer[_ <: Value[SType]]](
    ...
    SimpleTransformerSerializer[SByteArray, SByteArray](CalcBlake2b256Code, builder.CalcBlake2b256),
    SimpleTransformerSerializer[SByteArray, SByteArray](CalcSha256Code, builder.CalcSha256),
