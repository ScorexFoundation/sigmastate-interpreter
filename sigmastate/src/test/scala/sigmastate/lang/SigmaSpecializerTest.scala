...
//    spec(env, "fun (a: Int) = (1, 2L)(a)") shouldBe SFunc(IndexedSeq(SInt), SAny)
  ...
  property("AND flattening, CAND/COR untouched") {
    val sigmaBooleans1 = AND(Array(TrueLeaf, CAND(Array(proveDlogGen.sample.get, proveDHTGen.sample.get)).toSigmaProp.asBoolValue))
    spec(Map(), sigmaBooleans1) shouldBe sigmaBooleans1
    val sigmaBooleans2 = AND(Array(TrueLeaf, COR(Array(proveDlogGen.sample.get, proveDHTGen.sample.get)).toSigmaProp.asBoolValue))
  ...
  property("OR flattening, CAND/COR untouched") {
    val sigmaBooleans1 = OR(Array(TrueLeaf, CAND(Array(proveDlogGen.sample.get, proveDHTGen.sample.get)).toSigmaProp.asBoolValue))
    spec(Map(), sigmaBooleans1) shouldBe sigmaBooleans1
    val sigmaBooleans2 = OR(Array(TrueLeaf, COR(Array(proveDlogGen.sample.get, proveDHTGen.sample.get)).toSigmaProp.asBoolValue))
    spec(Map(), sigmaBooleans2) shouldBe sigmaBooleans2
  }
