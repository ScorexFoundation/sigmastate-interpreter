...
//    },
    ...
    { import SGlobalMethods._
      (SGlobal.typeId, Seq(
        ...
        Seq(MInfo(3, serializeMethod), MInfo(4, deserializeToMethod), MInfo(5, fromBigEndianBytesMethod), MInfo(8, someMethod), MInfo(9, noneMethod), MInfo(10, powHitMethod)) // methods added in v6.0
      } else {
        Seq.empty[MInfo]
      }), true)
    },
